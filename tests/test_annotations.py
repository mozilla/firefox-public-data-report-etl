...
@mock.patch("public_data_report.annotations.annotations.DEFAULT_USAGE_ANNOTATIONS", [{"annotation": "abc"}])
@mock.patch("public_data_report.annotations.annotations.USER_ACITVITY_COUNTRY_LIST", ["Brazil", "Canada", "France"])
...
def test_usage_annotations_countries():
    """Countries in annotations_webusage.json should exactly match the USER_ACITVITY_COUNTRY_LIST."""
